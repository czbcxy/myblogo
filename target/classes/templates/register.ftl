...
<head>
  ...
  <link rel="icon" href="favicon.ico(http://pk8hectkz.bkt.clouddn.com/bitbug_favicon)" type="image/x-icon">
  <link rel="shortcut icon" href="favicon.ico(http://pk8hectkz.bkt.clouddn.com/bitbug_favicon)" type="image/x-icon">


  <title>${title!'书中人 - 注册'}</title>

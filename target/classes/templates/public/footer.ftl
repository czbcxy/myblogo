            ...
            <div class="col-lg-6 text-center text-lg-left my-auto">
                <ul class="list-inline mb-2 text-white">
                    <li class="list-inline-item">
                        <a href="/post" class="text-white">年度自评</a>
                    </li>
                    <li class="list-inline-item">&sdot;</li>
                    <li class="list-inline-item">
                        <a href="/index" class="text-white">博客主页</a>
                    </li>
                    <li class="list-inline-item">&sdot;</li>
                    <li class="list-inline-item">
                        <a href="/resume" class="text-white">关于我的</a>
                    </li>
                    <li class="list-inline-item">&sdot;</li>
                    <li class="list-inline-item">
                        <a href="http://github.com/czbcxy" target="_blank" class="text-white">Github</a>
                    </li>
                </ul>
            ...
            <div class="col-lg-6 text-center text-lg-right my-auto">
                ...
                <#-- github -->
                    <li class="list-inline-item mr-3">
                        <a href="http://github.com/czbcxy" target="_blank" class="text-white">
                            <i class="fa fa-github fa-2x fa-fw"></i>
                        </a>
                    </li>
                <#-- qq -->
                    <li class="list-inline-item mr-3">
                        <a href="tencent://message/?uin=1053455023&Site=onLineQQ&amp;Menu=yes" class="text-white">
...
<#--<footer class="py-5 bg-dark">-->
<#--<div class="container">-->
<#--<p class="m-0 text-center text-white">Copyright &copy; FullStack by czbcxy 2016-2017</p>-->
<#--</div>-->
<#--<!-- /.container &ndash;&gt;-->
<#--</footer>-->